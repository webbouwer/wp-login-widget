...
<?php } else { // is logged in
			...
			*/
			...
			echo '<li class="menu-item"><a class="logout-link" href="'.wp_logout_url( 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'] ).'" title="Sign off"><span>'.__('Sign off', 'wploginwidget').'</span></a></li>';
...
function wploginwidget_tabs_js() {
...
add_action('wp_enqueue_scripts', 'wploginwidget_tabs_js');
